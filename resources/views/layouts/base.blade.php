...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-custom_nav">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active text-primary nav_lnk" aria-current="page" href="/">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-primary nav_lnk" href="#">Link</a>
          </li>

          <li class="nav-item">
            <a class="nav-link text-primary nav_lnk" href="#">About us</a>
          </li>
        ...
        <span class="navbar-text">
          ...
          <a href="{{route('register')}}" class="log_reg fw-bold text-primary">Register</a>
          @endif
          @endif
        </span>
