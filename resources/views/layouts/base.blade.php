...
<body>
    <div class="loginregister bg-dark ">
    
      <div class="bg-cus_log">
        <div class="row">
                <div class="col">
                ...
                <div class="col">
                  ...
                  @if(Route::has('login'))
                    ...
                    <div class="dropdown">
                          ...
                          <i class="fa fa-user drop_username" style="font-size:28px;"><span class="drop_username">{{Auth::user()->name}}</span> </i>
                          </a>
